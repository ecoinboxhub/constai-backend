...
def get_live_weather(city: str) -> Dict[str, Any]:
    ...
    if not settings.openweather_api_key or settings.openweather_api_key == "change-me":
        ...
        return {
            ...
            "message": "Weather API key missing. Live intelligence unavailable.",
            "source": "ConstAI Security Layer"
        }
    ...
    return {"error": "Unknown Error", "message": "Failed to resolve live weather intelligence."}
